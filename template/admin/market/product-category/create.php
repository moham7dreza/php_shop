                ...
                <section class="col-12">
                    <section class="main-body-container">
                        ...
                        <section class="body-content">
                            ...
                            <form class="row g-3" action="<?= url('admin/market/product-category/store') ?>" method="post" enctype="multipart/form-data">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="parent_id" id="parent_id">
                                        ...
                                        ?>
                                            <option value="<?= $product_categorie['id'] ?>" <?php if (old('parent_id') == $product_categorie['id']) echo "selected" ?>><?= $product_categorie['name'] ?></option>
                                        <?php
                                        }
                                        ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="show_in_menu" id="show_in_menu">
                                        <option value="1" <?php if (old('show_in_menu') == 1) echo "selected" ?>>فعال</option>
                                        <option value="2" <?php if (old('show_in_menu') == 2) echo "selected" ?>>غیر فعال</option>
                                    </select>
                                </div>
                                <div class="col-12">
