                ...
                <section class="col-12">
                    ...
                    <section class="main-body-container">
                        <section class="main-body-container-header d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="<?= url('admin/market/product-category/create') ?>" class="btn btn-success">ساخت</a>
                            </div>
                        </section>
                                    ...
                                    foreach ($categories as $category) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div class="mx-2">
                                                        <a href="<?= url('admin/market/product-category/delete/' . $category['id']) ?>" class="text-danger">
                                                            <i class="fa fa-trash"></i>
                                                        </a>
                                                    </div>
                                                    <div class="mx-2">
                                                        <a href="<?= url('admin/market/product-category/edit/' . $category['id']) ?>" class="text-warning">
    ...
    <script>
        ...
        statusBtns.forEach((statusBtn) => {
            statusBtn.addEventListener("change", (e) => {
                ...
                fetch(
                        `http://localhost/php-shop/admin/market/product-category/change-status/${id}`
                    )
