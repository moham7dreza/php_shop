                ...
                <section class="col-12">
                    <section class="main-body-container">
                        <section class="main-body-container-header d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="<?= url('admin/market/product-category') ?>" class="btn btn-warning">بازگشت</a>
                            </div>
                        </section>
                        <section class="body-content">

                            <form class="row g-3" action="<?= url('admin/market/product-category/update/' . $category['id']) ?>" method="post" enctype="multipart/form-data">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="parent_id" id="parent_id">
                                        ...
                                        <?php
                                        foreach ($product_categories as $singleCategory) {
                                            if ($singleCategory['id'] != $category['id']) {
                                        ?>
                                                <option value="<?= $singleCategory['id'] ?>" <?php if ($category['parent_id'] == $singleCategory['id']) echo "selected" ?>><?= $singleCategory['name'] ?></option>
                                        <?php
                                            }
                                        }
                                        ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="show_in_menu" id="show_in_menu">
                                        <option value="1" <?php if ($category['show_in_menu'] == 1) echo "selected" ?>>فعال</option>
                                        <option value="2" <?php if ($category['show_in_menu'] == 2) echo "selected" ?>>غیر فعال</option>
                                    </select>
                                </div>
                                <div class="col-12">
