                ...
                <section class="col-12">
                    <section class="main-body-container">
                        ...
                        <section class="body-content">
                            ...
                            <form class="row g-3" action="<?= url('admin/market/category-attribute/update/' . $attribute['id']) ?>" method="post">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="unit" class="form-control" id="unit" value="<?= $attribute['unit'] ?>">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="product_category_id" id="product_category_id">
                                        ...
                                        ?>
                                            <option value="<?= $category['id'] ?>" <?php if ($attribute['product_category_id'] == $category['id']) echo "selected" ?>><?= $category['name'] ?></option>
                                        <?php
                                        }
                                        ?>
