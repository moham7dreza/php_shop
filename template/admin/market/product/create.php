                ...
                <section class="col-12">
                    <section class="main-body-container">
                        ...
                        <section class="body-content">
                            ...
                            <form class="row g-3" action="<?= url('admin/market/product/store') ?>" method="post" enctype="multipart/form-data" id="form">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    ...
                                    <select class="form-select" name="brand_id" id="brand_id">
                                        ...
                                        ?>
                                            <option value="<?= $brand['id'] ?>" <?php if (old('brand_id') == $brand['id']) echo "selected" ?>><?= $brand['persian_name'] ?></option>
                                        <?php
                                        }
                                        ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="introduction" name="introduction" placeholder="introduction ..." rows="5" required autofocus></textarea>
