                ...
                <section class="col-12">
                    <section class="main-body-container">
                        ...
                        <section class="body-content">
                            ...
                            <form class="row g-3" action="<?= url('admin/content/menu/update/' . $menu['id']) ?>" method="post">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="parent_id" id="parent_id">
                                        ...
                                        ?>
                                                <option value="<?= $singleMenu['id'] ?>" <?php if ($menu['parent_id'] == $singleMenu['id']) echo "selected" ?>><?= $singleMenu['name'] ?></option>
                                        <?php
                                            }
                                        }
                                        ?>
