                ...
                <section class="col-12">
                    ...
                    <section class="main-body-container">
                        <section class="main-body-container-header d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="<?= url('admin/content/menu/create') ?>" class="btn btn-success">ساخت</a>
                            </div>
                        </section>
                                ...
                                <tbody>
                                    ...
                                    foreach ($menus as $menu) { ?>
                                        <tr>
                                            ...
                                            <td><?= $menu['name'] ?></td>
                                            <td><?= $menu['url'] ?></td>
                                            <td><?= $menu['parent_id'] ? $menu['parent_name'] : 'منوی اصلی'  ?></td>
                                            <td>
                                                <div class="d-flex">
                                                    <div class="mx-2">
                                                        <a href="<?= url('admin/content/menu/delete/' . $menu['id']) ?>" class="text-danger">
                                                            <i class="fa fa-trash"></i>
                                                        </a>
                                                    </div>
                                                    <div class="mx-2">
                                                        <a href="<?= url('admin/content/menu/edit/' . $menu['id']) ?>" class="text-warning">
