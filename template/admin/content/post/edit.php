                ...
                <section class="col-12">
                    <section class="main-body-container">
                        ...
                        <section class="body-content">
                            ...
                            <form class="row g-3" action="<?= url('admin/content/post/update/' . $post['id']) ?>" method="post" enctype="multipart/form-data" id="form">
                                <div class="col-md-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" name="slug" class="form-control" value="<?= $post['slug'] ?>" id="slug">
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <select class="form-select" name="post_category_id" id="post_category_id">
                                        ...
                                        ?>
                                            <option value="<?= $category['id'] ?>" <?php if ($post['post_category_id'] == $category['id']) echo "selected" ?>><?= $category['name'] ?></option>
                                        <?php
                                        }
                                        ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" id="tags" name="tags" value="<?= $post['tags'] ?>">
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="summary" value="<?= $post['summary'] ?>" class="form-control" id="summary">
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="status" id="status">
                                        ...
                                        <option value="2" <?php if ($post['status'] == 2) echo "selected" ?>>غیر فعال</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="commentable" id="commentable">
                                        ...
                                        <option value="2" <?php if ($post['commentable'] == 2) echo "selected" ?>>غیر فعال</option>
                                    </select>
                                </div>
