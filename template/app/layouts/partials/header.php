         ...
         <section class="container-xxl ">
             <section class="d-md-flex justify-content-md-between align-items-md-center py-3">
                 ...
                 <section class="d-flex justify-content-between align-items-center d-md-block">
                     <a class="text-decoration-none" href="<?= url('/') ?>"><img src="<?= asset('public/app/assets/images/logo/8.png') ?>" alt="logo"></a>
                 ...
                 <section class="mt-3 mt-md-auto text-end">
                        ...
                        ?>
                         <section class="d-inline px-md-3">
                             ...
                             <section class="dropdown-menu dropdown-menu-end custom-drop-down" aria-labelledby="dropdownMenuButton1">
                                 <section><a class="dropdown-item" href="<?= url('/profile/my-orders') ?>"><i class="fa fa-user-circle"></i>پروفایل کاربری</a></section>
                                 <section>
                                     <hr class="dropdown-divider">
                                 </section>
                                 <section><a class="dropdown-item" href="<?= url('logout') ?>"><i class="fa fa-sign-out-alt"></i>خروج</a></section>
                         ...
                         <section class="header-cart d-inline ps-3 border-start position-relative">
                             ...
                             <a class="btn btn-link position-relative text-dark header-cart-link" href="<?= url('/cart') ?>">
                             ...
                             <!-- <section class="header-cart-dropdown">
                                 <section class="border-bottom d-flex justify-content-between p-2">
                                     ...
                                     <a class="text-decoration-none text-info" href="<?= url('/cart') ?>">مشاهده سبد خرید </a>
                                 </section>
                     ...
                     <?php } else {
                        ...
                        ?>
                         <a href="<?= url('login-register') ?>" class="btn btn-warning">ورود / ثبت نام</a>
                     <?php } ?>
                 </section>
             </section>
         </section>
